...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'aastudio020@gmail.com' ")
...
# Title label
message3 = tk.Label(window, text="Face Recognition Based Attendance System", fg="white", bg="#262523", width=55, height=1, font=('times', 18, 'bold'))
...
# Frame 1 - Attendance
frame1 = tk.Frame(window, bg="#f0f0f0")
frame1.pack_forget()
...
frame2 = tk.Frame(window, bg="#f0f0f0")
frame2.pack_forget()
...
lbl = tk.Label(frame2, text="Enter ID", width=20, height=1, fg="black", bg="#f0f0f0", font=('times', 17, 'bold'))
lbl.place(x=80, y=55)

txt = tk.Entry(frame2, width=32, fg="black", font=('times', 15, 'bold'))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter Name", width=20, fg="black", bg="#f0f0f0", font=('times', 17, 'bold'))
lbl2.place(x=80, y=140)

txt2 = tk.Entry(frame2, width=32, fg="black", font=('times', 15, 'bold'))
txt2.place(x=30, y=173)

message1 = tk.Label(frame2, text="1)Take Images  >  2)Save Profile", bg="#f0f0f0", fg="black", width=39, height=1, activebackground="yellow", font=('times', 15, 'bold'))
...
frame3.pack_forget()
bg_image = PhotoImage(file="banner.png") 
...
frame4.pack_forget()
about_text = """\
This Attendance System is designed to provide a convenient 
and efficient way to monitor attendance 
...
Group Members: Aftab Hussain, Sajjad Hussain,  Yasir Hussain ,Jawaad Hussain
Version: 1.0
"""
